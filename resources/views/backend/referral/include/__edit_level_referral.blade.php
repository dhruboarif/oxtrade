            ...
            <div class="modal-body popup-body">
                ...
                <form action="" method="post" id="level-form">
                    ...
                    <div class="popup-body-text">
                        ...
                        <div class="site-input-groups">
                            <label for="" class="box-input-label">{{ __('Refer Needed:') }}</label>
                            <div class="input-group joint-input">
                                <input type="text" class="form-control refer_needed" name="refer_needed" oninput="this.value = validateDouble(this.value)">
                                <span class="input-group-text"></span>
                            </div>
                        </div>
