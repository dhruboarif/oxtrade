                            ...
                            <div class="site-table table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col">{{ __('Investment Per Link') }}</th>
                                        <th scope="col">{{ __('Personal Investment ') }}</th>
                                    ...
                                    @foreach($rankings as $ranking)
                                        <tr>
                                            ...
                                            <td>
                                                <strong>{{ $ranking->minimum_earning_per_link }}</strong>
                                            </td>
                                               <td>
                                                <strong>{{ $ranking->personal_investment.' '.$currency }}</strong>
                                            </td>
